namespace eval ::optrace {
  variable script "E:/Dev/QianSai/mipi_dp_vivado/mipi_dp.runs/impl_1/design_1_wrapper.tcl"
...
OPTRACE "set parameters" START { }
  set_property webtalk.parent_dir E:/Dev/QianSai/mipi_dp_vivado/mipi_dp.cache/wt [current_project]
  set_property parent.project_path E:/Dev/QianSai/mipi_dp_vivado/mipi_dp.xpr [current_project]
  set_property ip_repo_paths {
  E:/Dev/QianSai/xfcv_dev_hls/stitcher/stitcher/hls/impl/ip
  E:/Dev/QianSai/xfcv_dev_hls/xf_isp/xf_isp/hls/impl/ip
} [current_project]
  update_ip_catalog
  set_property ip_output_repo E:/Dev/QianSai/mipi_dp_vivado/mipi_dp.cache/ip [current_project]
  set_property ip_cache_permissions {read write} [current_project]
  set_property XPM_LIBRARIES {XPM_CDC XPM_FIFO XPM_MEMORY} [current_project]
OPTRACE "set parameters" END { }
OPTRACE "add files" START { }
  add_files -quiet E:/Dev/QianSai/mipi_dp_vivado/mipi_dp.runs/synth_1/design_1_wrapper.dcp
  set_msg_config -source 4 -id {BD 41-1661} -limit 0
  set_param project.isImplRun true
  add_files E:/Dev/QianSai/mipi_dp_vivado/mipi_dp.srcs/sources_1/bd/design_1/design_1.bd
  set_param project.isImplRun false
OPTRACE "read constraints: implementation" START { }
  read_xdc E:/Dev/QianSai/mipi_dp_vivado/mipi_dp.srcs/constrs_1/new/mipi.xdc
  read_xdc E:/Dev/QianSai/mipi_dp_vivado/mipi_dp.srcs/constrs_1/new/system.xdc
...
OPTRACE "Write Bitstream: pre hook" START { }
  set src_rc [catch { 
    puts "source E:/Dev/QianSai/mipi_dp_vivado/Scripts/drc_override.tcl"
    source E:/Dev/QianSai/mipi_dp_vivado/Scripts/drc_override.tcl
  } _RESULT] 
  if {$src_rc} { 
    set tool_flow [get_property -quiet TOOL_FLOW [current_project -quiet]]
    if { $tool_flow eq {SDx} } { 
      send_gid_msg -id 2 -ssname VPL_TCL -severity ERROR $_RESULT
      send_gid_msg -id 3 -ssname VPL_TCL -severity ERROR "sourcing script E:/Dev/QianSai/mipi_dp_vivado/Scripts/drc_override.tcl failed"
    } else {
      send_msg_id runtcl-1 status "$_RESULT"
      send_msg_id runtcl-2 status "sourcing script E:/Dev/QianSai/mipi_dp_vivado/Scripts/drc_override.tcl failed"
    }
    return -code error
  }
