...
entity design_1_v_demosaic_1_0_v_demosaic is
generic (
...
architecture behav of design_1_v_demosaic_1_0_v_demosaic is 
    attribute CORE_GENERATION_INFO : STRING;
    attribute CORE_GENERATION_INFO of behav : architecture is
    "design_1_v_demosaic_1_0_v_demosaic,hls_ip_2024_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xczu2cg-sfvc784-1-e,HLS_INPUT_CLOCK=6.667000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=4.834750,HLS_SYN_LAT=-1,HLS_SYN_TPT=-1,HLS_SYN_MEM=30,HLS_SYN_DSP=0,HLS_SYN_FF=9324,HLS_SYN_LUT=11644,HLS_VERSION=2024_2}";
    ...
    component design_1_v_demosaic_1_0_entry_proc IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
    ...
    component design_1_v_demosaic_1_0_AXIvideo2MultiBayer IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component design_1_v_demosaic_1_0_Debayer IS
    port (
        ap_start : IN STD_LOGIC;
        start_full_n : IN STD_LOGIC;
        start_out : OUT STD_LOGIC;
    ...
    component design_1_v_demosaic_1_0_ZipperRemoval IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component design_1_v_demosaic_1_0_MultiPixStream2AXIvideo IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component design_1_v_demosaic_1_0_fifo_w16_d3_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
    ...
    component design_1_v_demosaic_1_0_fifo_w10_d2_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component design_1_v_demosaic_1_0_fifo_w30_d2_S_x IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component design_1_v_demosaic_1_0_start_for_Debayer_U0 IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component design_1_v_demosaic_1_0_start_for_ZipperRemoval_U0 IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component design_1_v_demosaic_1_0_start_for_MultiPixStream2AXIvideo_U0 IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component design_1_v_demosaic_1_0_CTRL_s_axi IS
    generic (
...
begin
    CTRL_s_axi_U : component design_1_v_demosaic_1_0_CTRL_s_axi
    generic map (
    ...
    entry_proc_U0 : component design_1_v_demosaic_1_0_entry_proc
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
    ...
    AXIvideo2MultiBayer_U0 : component design_1_v_demosaic_1_0_AXIvideo2MultiBayer
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
    ...
    Debayer_U0 : component design_1_v_demosaic_1_0_Debayer
    port map (
    ...
    ZipperRemoval_U0 : component design_1_v_demosaic_1_0_ZipperRemoval
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
    ...
    MultiPixStream2AXIvideo_U0 : component design_1_v_demosaic_1_0_MultiPixStream2AXIvideo
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
    ...
    bayer_phase_c_U : component design_1_v_demosaic_1_0_fifo_w16_d3_S
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
    ...
    imgBayer_U : component design_1_v_demosaic_1_0_fifo_w10_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    imgRgb_U : component design_1_v_demosaic_1_0_fifo_w30_d2_S_x
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    imgUnzip_U : component design_1_v_demosaic_1_0_fifo_w30_d2_S_x
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    start_for_Debayer_U0_U : component design_1_v_demosaic_1_0_start_for_Debayer_U0
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    start_for_ZipperRemoval_U0_U : component design_1_v_demosaic_1_0_start_for_ZipperRemoval_U0
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    start_for_MultiPixStream2AXIvideo_U0_U : component design_1_v_demosaic_1_0_start_for_MultiPixStream2AXIvideo_U0
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
