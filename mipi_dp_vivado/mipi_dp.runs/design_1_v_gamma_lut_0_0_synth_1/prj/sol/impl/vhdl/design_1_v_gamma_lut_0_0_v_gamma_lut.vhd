...
architecture behav of design_1_v_gamma_lut_0_0_v_gamma_lut is 
    ...
    "design_1_v_gamma_lut_0_0_v_gamma_lut,hls_ip_2024_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xczu2cg-sfvc784-1-e,HLS_INPUT_CLOCK=6.667000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=3.608000,HLS_SYN_LAT=-1,HLS_SYN_TPT=-1,HLS_SYN_MEM=6,HLS_SYN_DSP=0,HLS_SYN_FF=907,HLS_SYN_LUT=1604,HLS_VERSION=2024_2}";
