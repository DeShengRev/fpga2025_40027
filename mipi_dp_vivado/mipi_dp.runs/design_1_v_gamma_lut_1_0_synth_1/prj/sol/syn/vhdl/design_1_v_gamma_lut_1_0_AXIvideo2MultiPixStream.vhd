...
entity design_1_v_gamma_lut_1_0_AXIvideo2MultiPixStream is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of design_1_v_gamma_lut_1_0_AXIvideo2MultiPixStream is 
...
attribute shreg_extract : string;
    ...
    signal grp_reg_unsigned_short_s_fu_222_ap_return : STD_LOGIC_VECTOR (10 downto 0);
    ...
    signal grp_reg_unsigned_short_s_fu_216_d : STD_LOGIC_VECTOR (10 downto 0);
    ...
    signal grp_reg_unsigned_short_s_fu_222_d : STD_LOGIC_VECTOR (10 downto 0);
    ...
    component design_1_v_gamma_lut_1_0_AXIvideo2MultiPixStream_Pipeline_loop_wait_for_start IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component design_1_v_gamma_lut_1_0_AXIvideo2MultiPixStream_Pipeline_loop_width IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component design_1_v_gamma_lut_1_0_AXIvideo2MultiPixStream_Pipeline_loop_wait_for_eol IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component design_1_v_gamma_lut_1_0_reg_unsigned_short_s IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component design_1_v_gamma_lut_1_0_regslice_both IS
    generic (
        DataWidth : INTEGER );
    port (
        ap_clk : IN STD_LOGIC;
...
begin
    grp_AXIvideo2MultiPixStream_Pipeline_loop_wait_for_start_fu_132 : component design_1_v_gamma_lut_1_0_AXIvideo2MultiPixStream_Pipeline_loop_wait_for_start
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    grp_AXIvideo2MultiPixStream_Pipeline_loop_width_fu_152 : component design_1_v_gamma_lut_1_0_AXIvideo2MultiPixStream_Pipeline_loop_width
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    grp_AXIvideo2MultiPixStream_Pipeline_loop_wait_for_eol_fu_180 : component design_1_v_gamma_lut_1_0_AXIvideo2MultiPixStream_Pipeline_loop_wait_for_eol
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    grp_reg_unsigned_short_s_fu_216 : component design_1_v_gamma_lut_1_0_reg_unsigned_short_s
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    grp_reg_unsigned_short_s_fu_222 : component design_1_v_gamma_lut_1_0_reg_unsigned_short_s
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    regslice_both_s_axis_video_V_data_V_U : component design_1_v_gamma_lut_1_0_regslice_both
    generic map (
        DataWidth => 32)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_s_axis_video_V_keep_V_U : component design_1_v_gamma_lut_1_0_regslice_both
    generic map (
        DataWidth => 4)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_s_axis_video_V_strb_V_U : component design_1_v_gamma_lut_1_0_regslice_both
    generic map (
        DataWidth => 4)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_s_axis_video_V_user_V_U : component design_1_v_gamma_lut_1_0_regslice_both
    generic map (
        DataWidth => 1)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_s_axis_video_V_last_V_U : component design_1_v_gamma_lut_1_0_regslice_both
    generic map (
        DataWidth => 1)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_s_axis_video_V_id_V_U : component design_1_v_gamma_lut_1_0_regslice_both
    generic map (
        DataWidth => 1)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_s_axis_video_V_dest_V_U : component design_1_v_gamma_lut_1_0_regslice_both
    generic map (
        DataWidth => 1)
    port map (
        ap_clk => ap_clk,
    ...
    cmp10252_i_fu_267_p2 <= "0" when (grp_reg_unsigned_short_s_fu_222_ap_return = ap_const_lv11_0) else "1";
    ...
    grp_reg_unsigned_short_s_fu_216_d <= height(11 - 1 downto 0);
    ...
    grp_reg_unsigned_short_s_fu_222_d <= width(11 - 1 downto 0);
    i_5_fu_287_p2 <= std_logic_vector(unsigned(i_fu_78) + unsigned(ap_const_lv11_1));
