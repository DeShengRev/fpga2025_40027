...
module design_1_v_gamma_lut_1_0_hls_deadlock_idx0_monitor ( // for module design_1_v_gamma_lut_1_0_v_gamma_lut_inst
    input wire clock,
    input wire reset,
...
// instant sub module
 design_1_v_gamma_lut_1_0_hls_deadlock_idx1_monitor design_1_v_gamma_lut_1_0_hls_deadlock_idx1_monitor_U (
    .clock(clock),
    .reset(reset),
