...
module design_1_v_gamma_lut_1_0_v_gamma_lut (
        s_axi_CTRL_AWVALID,
        s_axi_CTRL_AWREADY,
        s_axi_CTRL_AWADDR,
        s_axi_CTRL_WVALID,
...
design_1_v_gamma_lut_1_0_CTRL_s_axi #(
...
design_1_v_gamma_lut_1_0_AXIvideo2MultiPixStream AXIvideo2MultiPixStream_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst_n_inv),
...
design_1_v_gamma_lut_1_0_Gamma Gamma_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst_n_inv),
...
design_1_v_gamma_lut_1_0_MultiPixStream2AXIvideo MultiPixStream2AXIvideo_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst_n_inv),
...
design_1_v_gamma_lut_1_0_fifo_w30_d16_S imgRgb_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
design_1_v_gamma_lut_1_0_fifo_w30_d16_S imgGamma_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
design_1_v_gamma_lut_1_0_start_for_MultiPixStream2AXIvideo_U0 start_for_MultiPixStream2AXIvideo_U0_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
`include "design_1_v_gamma_lut_1_0_hls_deadlock_detector.vh"
// synthesis translate_on

reg find_kernel_block = 0;
// synthesis translate_off
`include "design_1_v_gamma_lut_1_0_hls_deadlock_kernel_monitor_top.vh"
// synthesis translate_on

endmodule //design_1_v_gamma_lut_1_0_v_gamma_lut
