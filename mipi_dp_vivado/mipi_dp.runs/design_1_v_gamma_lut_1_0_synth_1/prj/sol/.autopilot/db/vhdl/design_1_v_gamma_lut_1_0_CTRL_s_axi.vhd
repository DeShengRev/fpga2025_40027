...
entity design_1_v_gamma_lut_1_0_CTRL_s_axi is
generic (
...
end entity design_1_v_gamma_lut_1_0_CTRL_s_axi;
...
architecture behave of design_1_v_gamma_lut_1_0_CTRL_s_axi is
    ...
    component design_1_v_gamma_lut_1_0_CTRL_s_axi_ram is
        generic (
    ...
    end component design_1_v_gamma_lut_1_0_CTRL_s_axi_ram;
...
-- ----------------------- Instantiation------------------
-- int_gamma_lut_0
int_gamma_lut_0 : design_1_v_gamma_lut_1_0_CTRL_s_axi_ram
generic map (
     MEM_STYLE => "auto",
     MEM_TYPE  => "2P",
     BYTES     => 4,
...
-- int_gamma_lut_1
int_gamma_lut_1 : design_1_v_gamma_lut_1_0_CTRL_s_axi_ram
generic map (
     MEM_STYLE => "auto",
     MEM_TYPE  => "2P",
     BYTES     => 4,
...
-- int_gamma_lut_2
int_gamma_lut_2 : design_1_v_gamma_lut_1_0_CTRL_s_axi_ram
generic map (
     MEM_STYLE => "auto",
     MEM_TYPE  => "2P",
     BYTES     => 4,
...
entity design_1_v_gamma_lut_1_0_CTRL_s_axi_ram is
    generic (
        MEM_STYLE : STRING :="auto";
        MEM_TYPE  : STRING :="S2P";
        BYTES   : INTEGER :=4;
...
end entity design_1_v_gamma_lut_1_0_CTRL_s_axi_ram;

architecture behave of design_1_v_gamma_lut_1_0_CTRL_s_axi_ram is
