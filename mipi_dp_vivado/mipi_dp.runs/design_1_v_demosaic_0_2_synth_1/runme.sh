...
HD_PWD='E:/Dev/QianSai/mipi_dp_vivado/mipi_dp.runs/design_1_v_demosaic_0_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_v_demosaic_0_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_v_demosaic_0_2.tcl
