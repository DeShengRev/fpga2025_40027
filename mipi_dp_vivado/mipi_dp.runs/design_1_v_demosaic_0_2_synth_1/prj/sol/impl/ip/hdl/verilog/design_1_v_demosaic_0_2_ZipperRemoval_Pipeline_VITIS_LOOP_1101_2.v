...
module design_1_v_demosaic_0_2_ZipperRemoval_Pipeline_VITIS_LOOP_1101_2 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
always @ (*) begin
    ap_condition_535 = ((icmp_ln1107_reg_725 == 1'd1) & (icmp_ln1101_reg_721 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end
...
assign imgUnzip_din = {{{conv3_i_i188669_reg_767}, {conv3_i_i671_reg_757}}, {conv3_i_i79670_reg_762}};
...
endmodule //design_1_v_demosaic_0_2_ZipperRemoval_Pipeline_VITIS_LOOP_1101_2
