...
// Command     : write_verilog -force -mode synth_stub -rename_top design_1_v_gamma_lut_1_0 -prefix
//               design_1_v_gamma_lut_1_0_ design_1_v_gamma_lut_0_0_stub.v
...
(* CHECK_LICENSE_TYPE = "design_1_v_gamma_lut_0_0,design_1_v_gamma_lut_0_0_v_gamma_lut,{}" *) (* CORE_GENERATION_INFO = "design_1_v_gamma_lut_0_0,design_1_v_gamma_lut_0_0_v_gamma_lut,{x_ipProduct=Vivado 2024.2,x_ipVendor=xilinx.com,x_ipLibrary=ip,x_ipName=v_gamma_lut,x_ipVersion=1.1,x_ipCoreRevision=13,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED,C_S_AXI_CTRL_ADDR_WIDTH=13,C_S_AXI_CTRL_DATA_WIDTH=32}" *) (* DowngradeIPIdentifiedWarnings = "yes" *) 
(* X_CORE_INFO = "design_1_v_gamma_lut_0_0_v_gamma_lut,Vivado 2024.2" *) (* hls_module = "yes" *) 
