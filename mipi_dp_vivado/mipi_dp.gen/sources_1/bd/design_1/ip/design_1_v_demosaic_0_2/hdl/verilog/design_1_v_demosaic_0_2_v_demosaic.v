...
design_1_v_demosaic_0_2_entry_proc entry_proc_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst_n_inv),
...
design_1_v_demosaic_0_2_fifo_w16_d3_S bayer_phase_c_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
design_1_v_demosaic_0_2_fifo_w10_d2_S imgBayer_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
design_1_v_demosaic_0_2_fifo_w30_d2_S_x imgRgb_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
design_1_v_demosaic_0_2_fifo_w30_d2_S_x imgUnzip_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
design_1_v_demosaic_0_2_start_for_Debayer_U0 start_for_Debayer_U0_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
// synthesis translate_off
`include "design_1_v_demosaic_0_2_hls_deadlock_kernel_monitor_top.vh"
// synthesis translate_on
