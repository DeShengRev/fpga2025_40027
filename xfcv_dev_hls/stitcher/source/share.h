...
typedef ap_axiu<SRC_AXI_WIDTH, 1, 1, 1> SrcStrmBus;
typedef hls::stream<SrcStrmBus> SrcStrm;

#define XF_CV_DEPTH 3

typedef xf::cv::Mat<SRC_TYPE, SRC_HEIGHT, SRC_WIDTH, NPPCX, XF_CV_DEPTH> SrcPic;
typedef xf::cv::Mat<SRC_TYPE, PROC_HEIGHT, SRC_WIDTH, NPPCX, XF_CV_DEPTH> HalfPic;
typedef xf::cv::Mat<SRC_TYPE, PROC_HEIGHT, PROC_WIDTH, NPPCX, XF_CV_DEPTH> ProcPic;
typedef xf::cv::Mat<SRC_TYPE, PROC_HEIGHT, UNDERLAP_WIDTH, NPPCX, XF_CV_DEPTH> UnderlapPic;
typedef xf::cv::Mat<SRC_TYPE, PROC_HEIGHT, OVERLAP_WIDTH, NPPCX, XF_CV_DEPTH> OverlapPic;